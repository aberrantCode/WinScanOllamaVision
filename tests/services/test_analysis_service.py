...
class TestImageStatusTransitions:
    ...
    # Note: 3 obsolete status transition tests removed (lines 1243-1334)
    # These tested behavior where _analyze_single_page directly managed status updates.
    # Status updates are now handled by worker threads - see analysis_service.py line 293.
