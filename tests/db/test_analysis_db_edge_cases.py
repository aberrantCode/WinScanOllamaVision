...
def test_edge_cases():
    ...
    try:
        ...
        print(f"   ✓ Added {len(test_files)} sample analysis records")
        ...
        print(f"   ✓ High confidence count: {high_conf}")
        ...
        print("   ✓ Metadata completeness calculated correctly")
        ...
        print("   ✓ Cache hit rate calculated correctly")
        ...
        print("   ✓ Type distribution correct")
        ...
        print("   ✓ Company distribution correct")
        ...
        print(f"   ✓ Company filter: {len(pages)} pages")
        ...
        print(f"   ✓ Confidence filter: {len(pages)} pages")
        ...
        print(f"   ✓ Status filter (cached): {len(pages)} pages")
        ...
        print(f"   ✓ Document type filter: {len(pages)} pages")
        ...
        print("   ✓ Action items calculated correctly")
        ...
        print("   ✓ Speed and ETA calculated correctly")
        ...
        print("   ✓ Document insights correct")
