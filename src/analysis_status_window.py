...
class AnalysisStatusWindow(QDialog):
    ...
    def _create_collection_status_tab(self) -> QWidget:
        ...
        placeholder_label.setStyleSheet(f"font-size: 14pt; font-weight: bold; color: {self.theme_colors['text_tertiary']};")
        layout.addWidget(placeholder_label)

        info_label = QLabel("This tab will display collection-level statistics and analysis status.")
