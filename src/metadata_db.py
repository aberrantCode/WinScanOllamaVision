...
class MetadataDB:
    ...
    def save_metadata(
        ...
        additional_fields = {
            ...
            if k not in [
                'belongs', 'page_number', 'total_pages', 'page_position',
                'confidence', 'company', 'document_type', 'document_date'
            ]
        }
        ...
        """, (
            ...
            belongs_to_same_doc, page_number, total_pages, page_position, confidence,
            company, document_type, document_date,
            additional_data, model_used, processing_time_ms
        ))
    ...
    def get_archived_document(self, pdf_path: str) -> Optional[Dict[str, Any]]:
        """
